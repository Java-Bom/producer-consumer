...
public class ThreadPoolConfig {
    ...
    @Bean
    public ThreadPoolTaskExecutor cardPayFailureThreadPool() {
        ThreadPoolTaskExecutor threadPoolTaskExecutor = new ThreadPoolTaskExecutor();
        threadPoolTaskExecutor.setMaxPoolSize(100);
        threadPoolTaskExecutor.setCorePoolSize(20);
        threadPoolTaskExecutor.setQueueCapacity(15); // 이만큼 늘어났을 때 스레드풀이 늘어난다.
        threadPoolTaskExecutor.setThreadGroupName("CARD PAYMENT FAILURE THREAD");
        return threadPoolTaskExecutor;
    }

    @Bean
    public ThreadPoolTaskExecutor cashPayFailureThreadPool() {
        ThreadPoolTaskExecutor threadPoolTaskExecutor = new ThreadPoolTaskExecutor();
        threadPoolTaskExecutor.setMaxPoolSize(100);
        threadPoolTaskExecutor.setCorePoolSize(20);
        threadPoolTaskExecutor.setQueueCapacity(15); // 이만큼 늘어났을 때 스레드풀이 늘어난다.
        threadPoolTaskExecutor.setThreadGroupName("CASH PAYMENT FAILURE THREAD");
        return threadPoolTaskExecutor;
    }
